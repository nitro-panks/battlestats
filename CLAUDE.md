...
- D3-based SVG chart components (TierSVG, TypeSVG, ActivitySVG, RankedWRBattlesHeatmapSVG, RankedSeasonScatterSVG — the ranked-history per-season battles×WR scatter, glyph-shape-by-league + `RankedLeagueLegend`, …)
