...
export const ja: Partial<Record<StringKey, string>> = {
    ...
    'player.section.shipsPlayedInWindow': 'この期間に乗った艦艇',
    ...
    'battleHistory.window.sixty': '60日',
    'battleHistory.window.seventyfive': '75日',
    ...
    'battleHistory.header.last60': '直近60日間',
    'battleHistory.header.last75': '直近75日間',
