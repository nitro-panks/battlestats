...
| `battle-history-ships-scope` | `{scope:'top8'\|'all'}` (`top10` in 3.2.5–3.2.6 captures) | Click the battles×dmg ships treemap's Top 8 \| All scope filter | `BattleHistoryTreemaps.tsx` (setShipScope) | 🟡 deployed v3.2.7, awaiting captures |
