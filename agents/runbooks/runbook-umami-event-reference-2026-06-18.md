...
| `battle-history-ships-scope` | `{scope:'top10'\|'all'}` | Click the ships-by-damage treemap's Top 10 \| All scope filter | `BattleHistoryTreemaps.tsx` (setShipScope) | 🟡 deployed v3.2.6, awaiting captures |
