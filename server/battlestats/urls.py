...
urlpatterns = [
    ...
    path('api/realm/<str:realm>/top-ships',
         realm_top_ships, name='realm_top_ships_no_slash'),
    path('api/realm/<str:realm>/ships/',
         realm_ships_by_tier_type, name='realm_ships_by_tier_type'),
    path('api/realm/<str:realm>/ships',
         realm_ships_by_tier_type, name='realm_ships_by_tier_type_no_slash'),
    path('api/realm/<str:realm>/ship/<int:ship_id>/leaderboard/',
         ship_leaderboard, name='ship_leaderboard'),
    path('api/realm/<str:realm>/ship/<int:ship_id>/leaderboard',
         ship_leaderboard, name='ship_leaderboard_no_slash'),
