...
def get_hindsight_config_summary(context: dict[str, Any] | None = None) -> dict[str, Any]:
    api_url = _resolve_text(context, "hindsight_api_url", "BATTLESTATS_HINDSIGHT_API_URL", "HINDSIGHT_API_URL") or DEFAULT_HINDSIGHT_API_URL
    api_key = _resolve_text(context, "hindsight_api_key", "HINDSIGHT_API_KEY")
    budget = _resolve_text(context, "hindsight_budget", "BATTLESTATS_HINDSIGHT_BUDGET") or "mid"
    max_tokens = _resolve_int(context, "hindsight_max_tokens", "BATTLESTATS_HINDSIGHT_MAX_TOKENS", 4096)
