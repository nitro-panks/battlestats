...
# The weekly / monthly / yearly rollup tiers (`_PlayerPeriodShipStatsBase`
# + PlayerWeekly/Monthly/YearlyShipStats) were removed 2026-06-15 (DB-growth
# followup, step 2 KILL): the tables were dropped to reclaim ~1.18 GB, the
