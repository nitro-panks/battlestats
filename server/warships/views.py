...
@api_view(["GET"])
@throttle_classes(PUBLIC_API_THROTTLES)
def landing_active_players(request) -> Response:
    ...
    """
    realm = _get_realm(request)
    return Response(get_landing_active_players_payload(realm=realm))
